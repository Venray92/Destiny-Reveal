...
def test_hitung_zodiak_contoh_umum():
    assert hitung_zodiak(date(1992, 12, 5)) == {
        "sign": "Sagittarius", "element": "Api",
        "modality": "Mutable", "ruling_planet": "Jupiter",
    }
    assert hitung_zodiak(date(1992, 7, 20)) == {
        "sign": "Cancer", "element": "Air",
        "modality": "Kardinal", "ruling_planet": "Bulan",
    }
    assert hitung_zodiak(date(1992, 8, 15)) == {
        "sign": "Leo", "element": "Api",
        "modality": "Fixed", "ruling_planet": "Matahari",
    }
